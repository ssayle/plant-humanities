<style>
    ez-header ul {display: none;}
</style>

`ez-meta title="Plant Humanities Lab: Contributors"`

`ez-header subtitle="Contributors"`
...
![](https://raw.githubusercontent.com/plant-humanities/essays/main/contributors/Emery.jpg)
